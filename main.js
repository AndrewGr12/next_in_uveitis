...
document.addEventListener('DOMContentLoaded', function () {
  ...
  newsletterForm.addEventListener('submit', function (e) {
    ...
    .then(response => response.text())
    .then(text => {
      const successMessage = document.getElementById('newslettersuccessMessage'); // Corrected here
      if (text.includes('Success')) {
        // Show success message
        successMessage.style.display = 'block';
  ...
  contactForm.addEventListener('submit', function (e) {
    ...
    .then(response => response.text())
    .then(text => {
      const successMessage = document.getElementById('signupsuccessMessage'); // Corrected here
      if (text.includes('Success')) {
        // Show success message
        successMessage.style.display = 'block';
        successMessage.innerHTML = 'Message sent! ✅';
